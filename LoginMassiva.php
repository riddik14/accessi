...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "PrenotazioneMassiva.php";
  $MM_redirectLoginFailed = "LoginMassiva.php";
  $MM_redirecttoReferrer = false;
  	
      $query_Login = sprintf("SELECT Username, Password, CF, Nome, Cognome, IDnome FROM pre_elenconomi WHERE Username='%s' AND Password='%s'",
      addslashes($loginUsername), addslashes($password));
...
<div class="main-container">
    <h1 class="login-title">Login operatori</h1>
