...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "VTV.php";
  $MM_redirectLoginFailed = "LoginVTV.php";
  $MM_redirecttoReferrer = false;
  	
      $query_Login = "SELECT Username, Password, CF, Nome, Cognome, IDnome FROM pre_elenconomi WHERE Username=? AND Password=? AND VTV=2";
      $stmt = $PRES_conn->prepare($query_Login);
...
<h1 class="login-title">Login VTV</h1>
